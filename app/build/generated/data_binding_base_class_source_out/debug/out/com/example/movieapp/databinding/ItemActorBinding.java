...
public final class ItemActorBinding implements ViewBinding {
  ...
  private ItemActorBinding(@NonNull CardView rootView, @NonNull ImageView ivActorPhoto,
      @NonNull TextView tvName, @NonNull TextView tvNationality, @NonNull TextView tvRole) {
  ...
  public static ItemActorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemActorBinding((CardView) rootView, ivActorPhoto, tvName, tvNationality, tvRole);
    }
